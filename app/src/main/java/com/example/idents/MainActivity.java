...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void pindahActivityTanpaData()  {
        Intent moveIntent = new Intent( packageContext: MainActivity.this, SecondActivity.class);
    ...
    private void pindaActivityData()    {
        ...
        Intent moveIntentWithData = new Intent( PackageContext: MainActivity.this, SecondActivity.class());
